...
type ArticleServiceClient interface {
	...
	GetArticles(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *articleServiceClient) CreateArticle(ctx context.Context, in *Article, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (c *articleServiceClient) GetArticles(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedArticleServiceServer) CreateArticle(context.Context, *Article) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateArticle not implemented")
}
func (UnimplementedArticleServiceServer) GetArticles(context.Context, *GetRequest) (*Response, error) {
...
func _ArticleService_GetArticles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArticleServiceServer).GetArticles(ctx, req.(*GetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
